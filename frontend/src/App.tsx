...
import { DashboardGuidancePanels } from './components/DashboardGuidancePanels';
import { DashboardBlueprintPicker } from './components/DashboardBlueprintPicker';
      ...
      <main className="flex-1 flex flex-col overflow-hidden">
        ...
        {activeScreen === 'dashboard' && (
          ...
          >
            ...
            <DashboardGuidancePanels
              hasActiveTheme={Boolean(activeThemeDetail)}
              nextActionGuides={nextActionGuides}
              usabilityChecklist={nonCoderUsabilityChecklist}
            />

            <DashboardBlueprintPicker
              blueprintGuides={blueprintGuides}
              blueprintAudiences={blueprintAudiences}
              blueprintScreenSets={blueprintScreenSets}
              blueprintStacks={blueprintStacks}
              selectedBlueprintIndex={selectedBlueprintIndex}
              selectedBlueprintAudience={selectedBlueprintAudience}
              selectedBlueprintScreenSet={selectedBlueprintScreenSet}
              selectedBlueprintStack={selectedBlueprintStack}
              onSelectBlueprintIndex={setSelectedBlueprintIndex}
              onSelectAudience={setSelectedBlueprintAudience}
              onSelectScreenSet={setSelectedBlueprintScreenSet}
              onSelectStack={setSelectedBlueprintStack}
            ...
            <div className="w-[480px] bg-[#0c0f1b] border-r border-[#202538] flex flex-row overflow-hidden">
              ...
              <div className="flex-1 flex flex-col overflow-hidden bg-[#0c0f1b]">
                ...
                <div className="px-6 pt-6 pb-2 shrink-0 border-b border-[#202538] bg-[#0c0f1b]">
                  ...
                  <div className="mt-4">
                    {(() => {
                      const builderAction = getBuilderNextAction(activeStep);
                      return (
                        <NextBestActionBanner
                          ...
                          onAction={() => {
                            if (builderAction.targetScreen === 'export') setActiveScreen('export');
                            else if (typeof builderAction.targetStep === 'number') setActiveStep(builderAction.targetStep);
                          }}
